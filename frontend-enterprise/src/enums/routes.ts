export enum EnterpriseRoute {
  ...
  DataQuery = '/enterprise/data-query',
  DataQueryTemplateNew = '/enterprise/data-query/templates/new',
  DataQueryTemplateEdit = '/enterprise/data-query/templates/:templateId',
